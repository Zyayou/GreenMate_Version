...
public class News_3 extends Fragment {
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (itemList.size() >= 4) {
                textNews3.setText(itemList.get(2).getTitle());

                // 이미지 로딩 라이브러리 (Glide)를 사용하여 이미지 설정
                Glide.with(News_3.this).load(itemList.get(2).getImgUrl()).into(imgNews3);
                // 각 항목의 URL을 저장하거나 사용
