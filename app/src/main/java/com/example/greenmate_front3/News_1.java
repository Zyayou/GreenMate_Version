...
public class News_1 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        news1Layout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent urlintent1 = new Intent(Intent.ACTION_VIEW, Uri.parse("https://www.hkbs.co.kr"+url1));
    ...
    Handler handler = new Handler(){
        ...
        public void handleMessage(Message msg) {
            ...
            if (itemList.size() >= 4) {
                textNews1.setText(itemList.get(0).getTitle());

                // 이미지 로딩 라이브러리 (Glide)를 사용하여 이미지 설정
                Glide.with(News_1.this).load(itemList.get(0).getImgUrl()).into(imgNews1);
                // 각 항목의 URL을 저장하거나 사용
